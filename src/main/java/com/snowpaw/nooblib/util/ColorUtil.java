...
public class ColorUtil {
    ...
    public static float colorLightBlueR = 0F;
    public static float colorLightBlueG = 0.5F;
    public static float colorLightBlueB = 1F;
    ...
    public static float colorBrownR = 1F;
    public static float colorBrownG = 0.5F;
    public static float colorBrownB = 0F;
